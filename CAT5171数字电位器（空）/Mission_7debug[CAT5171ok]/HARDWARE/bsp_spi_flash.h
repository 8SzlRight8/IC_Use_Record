...
#define SPI_FLASH_BlockSize            0X8000
#define SBLOCK(x)                       0x00000000 + (0X00008000 * x)
...
#define W25X_SBlockErase			    0x52			//32KB块擦除
#define W25X_BBlockErase			    0xD8 			//64KB块擦除
#define W25X_SectorErase		      0x20 			//扇区删除4KB
