...
#define EEPROM_I2C_GPIO_PORT				GPIOC			/* GPIO端口 */
#define EEPROM_I2C_GPIO_CLK			 	RCC_AHB1Periph_GPIOC		/* GPIO端口时钟 */
#define EEPROM_I2C_SCL_PIN					GPIO_Pin_12			/* 连接到SCL时钟线的GPIO */
#define EEPROM_I2C_SDA_PIN					GPIO_Pin_10			/* 连接到SDA数据线的GPIO */
