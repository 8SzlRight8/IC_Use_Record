...
__IO uint16_t ChannelPulse = 125;
/**
...
static void TIMx_GPIO_Config(void) 
{
	...
	/*开启定时器相关的GPIO外设时钟*/
	RCC_AHB1PeriphClockCmd (ADVANCE_OCPWM_GPIO_CLK | ADVANCE_OCNPWM_GPIO_CLK, ENABLE); 
	RCC_AHB1PeriphClockCmd (ADVANCE_BKIN_GPIO_CLK, ENABLE); 
...
static void TIM_Mode_Config(void)
{
  ...
  TIM_TimeBaseStructure.TIM_Prescaler = 9-1;	    //调成9-1  ，就是20k（原本是1800/100HZ）
  // 采样时钟分频
